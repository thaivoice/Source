...
public class FileListActivity extends BaseFileListActivity {
	...
	private void prepareActionBar() {
		...
		mSpinnerAdapter = new ArrayAdapter<CharSequence>(this, android.R.layout.simple_dropdown_item_1line, gotoLocations);
...
//			menu.findItem(R.id.menu_bookmark_toggle).setChecked(bookmarker.isBookmarked(currentDir.getAbsolutePath()));
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (itemId == android.R.id.home) {
			...
			finish();
			return true;
		} /*else if (itemId == R.id.menu_bookmark_toggle) {
			...
			return true;
		}*/ else if (itemId == R.id.menu_media_exclusion) {
